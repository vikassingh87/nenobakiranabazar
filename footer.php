                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            <div class="footer-widget">
                                <div class="footer-widget-img pb-30">
                                    <a href="#">
                                        <img src="images/logo/logo1.png" alt="" style="max-width: 150px;">
                                    </a>
                                </div>
                                <ul class="toggle-footer text-white">
                                    ...
                                    <li class="pl-45">
                                        ...
                                        <p>+91 9834637366 <br> +91 8087496157<br> +91 9322383838</p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <div class="text-white footer-information">
                                ...
                                <ul class="footer-menu">
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>Home</a></li>
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>About Us</a></li>
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>Products Gallery</a></li>
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>Register</a></li>
                                    <li><a href="#"><i class="zmdi zmdi-chevron-right"></i>Login</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6">
                        ...
                        <div class="col-md-3 col-sm-6">
                            <div class="text-white footer-about-us">
                                ...
                                <p style="text-align: justify;">"Nenoba Kirana Bazar" is a division of Nenoba Kirana Bazar Head Quarters at Noida, Delhi, India. Our businesses includes Education, Hospitality, Wellness, E Commerce, Direct Selling, Real Estate and Retail.</p>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="copyright text-white">
                                <p>Copyright <i class="fa fa-copyright"></i> <?php echo date('Y'); ?>-2019 <a href="" target="_blank" ></a> All rights reserved. || <a href="https://easywebsoftsolutions.com" target="_blank"> Easy Websoft Solutions</a> </p>
                            </div>
                        </div>
                        <div class="col-sm-6">
