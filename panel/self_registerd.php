    ...
    <div class="">
      <div id="">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">My Direct Inactive Team</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                        	...
                        	<table class="table table-bordered" id="example2">
                                ...
                                <?php
                                 $uname = $_SESSION["userid"];
                                    //$userid="";
									$i=1;
									$query = mysqli_query($conn,"SELECT * FROM user where sponsor_id='$uname' and status='0'")or die(mysqli_error($conn));
									if(mysqli_affected_rows($conn)>0){
										...
										?>
                                        	<tr>
                                                ...
                                                <td><?php  echo $date=$row['date_joining'];?></td>
