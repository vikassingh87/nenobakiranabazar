         ...
         <div class="card">
            <form id="add_product" autocomplete="off">
               <div class="card-body">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <select name="product_type" class="form-control">
                              ...
                              <option value="KG" <?=!empty($product_info['product_type']) && $product_info['product_type'] == 'KG'?'selected':'';?>>KG</option>
                              <option value="PCS" <?=!empty($product_info['product_type']) && $product_info['product_type'] == 'PCS'?'selected':'';?>>PCS</option>
                              <option value="Liter" <?=!empty($product_info['product_type']) && $product_info['product_type'] == 'Liter'?'selected':'';?>>Liter</option>
                              <option value="Dozen" <?=!empty($product_info['product_type']) && $product_info['product_type'] == 'Dozen'?'selected':'';?>>Dozen</option>
                           </select>
                        </div>
                     </div>
                     <div class="col-md-6">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <label class="m-t-15">Generate Barcode</label>
                        <div class="input-group">
                           <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="generate_barcode_yes" name="generate_barcode" value="1" <?=!isset($product_info['generate_barcode']) || $product_info['generate_barcode'] == '1'?'checked':''; ?>>
                              <label class="custom-control-label" for="generate_barcode_yes">Yes</label>
                           </div>
                           &nbsp;&nbsp;
                           <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="generate_barcode_no" name="generate_barcode" value="0" <?=isset($product_info['generate_barcode']) && $product_info['generate_barcode'] == 0 ?'checked':''; ?>>
                              <label class="custom-control-label" for="generate_barcode_no">No</label>
                           </div>
                        </div>
                     </div>
                     
                     <div class="col-md-6" id="display_barcode">
                        <label class="m-t-15">Barcode</label>
                        <div class="input-group">
                           <input type="text" name="barcode" id="barcode" class="form-control" value="<?php echo $barcode; ?>" readonly>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="input-group">
                           <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="product_in_stock_yes" name="product_in_stock" value="1" <?=!isset($product_info['product_in_stock']) || $product_info['product_in_stock'] == '1'?'checked':''; ?>>
                              <label class="custom-control-label" for="product_in_stock_yes">Yes</label>
                           </div>
                           &nbsp;&nbsp;
                           <div class="custom-control custom-radio">
                              <input type="radio" class="custom-control-input" id="product_in_stock_no" name="product_in_stock" value="0" <?=isset($product_info['product_in_stock']) && $product_info['product_in_stock'] == 0 ?'checked':''; ?>>
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <div class="input-group">
                              <div class="custom-control custom-radio">
                                 <input type="radio" class="custom-control-input" id="product_publish_yes" name="product_publish" value="1" <?=!isset($product_info['product_publish']) || $product_info['product_publish'] == '1'?'checked':''; ?>>
                                 <label class="custom-control-label" for="product_publish_yes">Yes</label>
                              </div>
                              &nbsp;&nbsp;
                              <div class="custom-control custom-radio">
                                 <input type="radio" class="custom-control-input" id="product_publish_now" name="product_publish" value="0"  <?=isset($product_info['product_publish']) && $product_info['product_publish'] == 0 ?'checked':''; ?>>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <label class="m-t-15">GST</label>
                        <input type="number" name="product_gst" id="product_gst" class="form-control" min="1" value="<?=isset($product_info['product_gst'])?$product_info['product_gst']:''; ?>">
                     </div>
...
<script>
   $('input:radio[name="generate_barcode"]').change(
    function(){
        if (this.checked && this.value == '0') {
            $('#display_barcode').hide();
        }
        else{
            $('#display_barcode').show();
        }
    });
