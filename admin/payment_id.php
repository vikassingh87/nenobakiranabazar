...
<!-- end -->
                        ...
                        <div class="table-responsive" id="searchbyid">
                           <table class="table table-bordered table-striped" id="table_id" style="border: 1px solid black;">
                            <thead>
                           ...
                           // $email="";
                            $i=1;
                            $query = mysqli_query($conn,"SELECT * from user where status='1' AND payment_mode!='1' order by id desc");
