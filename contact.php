<?php include 'header.php'; ?>
        ...
        <div class="breadcrumbs-area section-padding" style="background-image:url(images/pro_img/banner.jpg);">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumbs text-center text-white">
                           <h3 class="text-uppercase" style="color: red;">Contact</h3> 
                        ...
                        <div class="address-info p-90 clearfix">
                            ...
                            <div class="col-md-offset-2 col-md-5 col-sm-6">
                                <div class="contact-address">
                                    ...
                                    <ul class="toggle-footer text-ash ">
